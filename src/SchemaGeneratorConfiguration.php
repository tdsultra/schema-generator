        ...
        $treeBuilder
            ...
            ->children()
                ...
                ->arrayNode('id')
                    ...
                    ->children()
                        ->scalarNode('name')->defaultValue('id')->info('Name of the id')->end()
                ...
                ->arrayNode('types')
                    ...
                    ->arrayPrototype()
                        ->children()
                            // add supporrt for optional primary key per resourceType
                            ->arrayNode('pk')
                                ->info('IDs overrides')
                                ->children()
                                    ->scalarNode('name')->defaultValue('id')->info('Name of the id')->end()
                            ...
                            ->arrayNode('properties')
                                ...
                                ->arrayPrototype()
                                    ...
                                    ->children()
                                        ...
                                        // add support for optional key=>value array for better clarity
                                        ->arrayNode('orm')
                                        ...
                                        ->booleanNode('formatName')->defaultTrue()->info('Should we format the name for consistency?')->end()
